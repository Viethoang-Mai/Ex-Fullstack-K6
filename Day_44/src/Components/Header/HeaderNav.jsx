...
export default function headerNav() {
    return (
        <nav className="ml-10 hidden items-center gap-8 lg:flex">
            <a
                href="#!"
                className="link-page antialiased font-sans text-base leading-relaxed flex items-center gap-2 font-medium text-gray-900"
            >
                <svg
            ...
            <a
                href="#!"
                className="link-count antialiased font-sans text-base leading-relaxed flex items-center gap-2 font-medium text-gray-900"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
            ...
            <a
                ...
                className="link-docs antialiased font-sans text-base leading-relaxed flex items-center gap-2 font-medium text-gray-900"
                target="_blank"
            >
                <svg
                    xmlns="http://www.w3.org/2000/svg"
